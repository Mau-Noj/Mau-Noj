...
```yaml
nombre    : Brandon Mauricio Noj
rol       : Technical Consultant
ubicacion : Guatemala 🇬🇹
estudios  :
  - Systems & Science Engineering @ USAC (Senior)
  - Environmental Engineering (Paralelo)
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>Aplicación web responsiva con pipeline de CI/CD y deployment automatizado. Diseñada para rendimiento y mantenibilidad.</p>
      <p>
    ...
    <td width="50%" valign="top">
      ...
      <p>Parser que genera Abstract Syntax Trees para gramáticas personalizadas. Análisis léxico, sintáctico y semántico completo.</p>
      <p>
  ...
  <tr>
    <td width="50%" valign="top">
      <h3>🐳 Taiga PM — Local DevOps</h3>
      <p>Orquestación de entorno local para gestión ágil de proyectos. Nginx como reverse proxy con configuración Docker multi-contenedor.</p>
      <p>
    ...
    <td width="50%" valign="top">
      <h3>⚙️ FlexiCalc API</h3>
      <p>API robusta para cálculos dinámicos integrada al portafolio. Arquitectura RESTful con endpoints flexibles y documentados.</p>
      <p>
...
### ¿Hablamos? Siempre abierto a colaboraciones, proyectos y oportunidades. 🚀
